...
//  def colorMode(mode: String, max: js.UndefOr[Short] = js.undefined): p5 = js.native
  def colorMode(mode: String): p5 = js.native
  def colorMode(mode: String, max: Short): p5 = js.native

//  def colorMode(mode: String, max1: Short, max2: Short, max3: Short, maxA: js.UndefOr[Short] = js.undefined): p5 = js.native
  def colorMode(mode: String, max1: Short, max2: Short, max3: Short): p5 = js.native
  def colorMode(mode: String, max1: Short, max2: Short, max3: Short, maxA: Short): p5 = js.native


  def fill(value: String): p5 = js.native

  def fill(gray: Short, alpha: js.UndefOr[Short] = js.undefined): p5 = js.native
//  def fill(gray: Short): p5 = js.native
//  def fill(gray: Short, alpha: Short): p5 = js.native
